function e(e,t,i,a){var r,n=arguments.length,s=n<3?t:null===a?a=Object.getOwnPropertyDescriptor(t,i):a;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,i,a);else for(var o=e.length-1;o>=0;o--)(r=e[o])&&(s=(n<3?r(s):n>3?r(t,i,s):r(t,i))||s);return n>3&&s&&Object.defineProperty(t,i,s),s}"function"==typeof SuppressedError&&SuppressedError;const t=globalThis,i=t.ShadowRoot&&(void 0===t.ShadyCSS||t.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,a=Symbol(),r=new WeakMap;let n=class{constructor(e,t,i){if(this._$cssResult$=!0,i!==a)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e,this.t=t}get styleSheet(){let e=this.o;const t=this.t;if(i&&void 0===e){const i=void 0!==t&&1===t.length;i&&(e=r.get(t)),void 0===e&&((this.o=e=new CSSStyleSheet).replaceSync(this.cssText),i&&r.set(t,e))}return e}toString(){return this.cssText}};const s=(e,...t)=>{const i=1===e.length?e[0]:t.reduce((t,i,a)=>t+(e=>{if(!0===e._$cssResult$)return e.cssText;if("number"==typeof e)return e;throw Error("Value passed to 'css' function must be a 'css' function result: "+e+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(i)+e[a+1],e[0]);return new n(i,e,a)},o=i?e=>e:e=>e instanceof CSSStyleSheet?(e=>{let t="";for(const i of e.cssRules)t+=i.cssText;return(e=>new n("string"==typeof e?e:e+"",void 0,a))(t)})(e):e,{is:l,defineProperty:d,getOwnPropertyDescriptor:c,getOwnPropertyNames:h,getOwnPropertySymbols:p,getPrototypeOf:u}=Object,_=globalThis,m=_.trustedTypes,f=m?m.emptyScript:"",g=_.reactiveElementPolyfillSupport,b=(e,t)=>e,v={toAttribute(e,t){switch(t){case Boolean:e=e?f:null;break;case Object:case Array:e=null==e?e:JSON.stringify(e)}return e},fromAttribute(e,t){let i=e;switch(t){case Boolean:i=null!==e;break;case Number:i=null===e?null:Number(e);break;case Object:case Array:try{i=JSON.parse(e)}catch(e){i=null}}return i}},x=(e,t)=>!l(e,t),w={attribute:!0,type:String,converter:v,reflect:!1,useDefault:!1,hasChanged:x};Symbol.metadata??=Symbol("metadata"),_.litPropertyMetadata??=new WeakMap;let y=class extends HTMLElement{static addInitializer(e){this._$Ei(),(this.l??=[]).push(e)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(e,t=w){if(t.state&&(t.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(e)&&((t=Object.create(t)).wrapped=!0),this.elementProperties.set(e,t),!t.noAccessor){const i=Symbol(),a=this.getPropertyDescriptor(e,i,t);void 0!==a&&d(this.prototype,e,a)}}static getPropertyDescriptor(e,t,i){const{get:a,set:r}=c(this.prototype,e)??{get(){return this[t]},set(e){this[t]=e}};return{get:a,set(t){const n=a?.call(this);r?.call(this,t),this.requestUpdate(e,n,i)},configurable:!0,enumerable:!0}}static getPropertyOptions(e){return this.elementProperties.get(e)??w}static _$Ei(){if(this.hasOwnProperty(b("elementProperties")))return;const e=u(this);e.finalize(),void 0!==e.l&&(this.l=[...e.l]),this.elementProperties=new Map(e.elementProperties)}static finalize(){if(this.hasOwnProperty(b("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(b("properties"))){const e=this.properties,t=[...h(e),...p(e)];for(const i of t)this.createProperty(i,e[i])}const e=this[Symbol.metadata];if(null!==e){const t=litPropertyMetadata.get(e);if(void 0!==t)for(const[e,i]of t)this.elementProperties.set(e,i)}this._$Eh=new Map;for(const[e,t]of this.elementProperties){const i=this._$Eu(e,t);void 0!==i&&this._$Eh.set(i,e)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(e){const t=[];if(Array.isArray(e)){const i=new Set(e.flat(1/0).reverse());for(const e of i)t.unshift(o(e))}else void 0!==e&&t.push(o(e));return t}static _$Eu(e,t){const i=t.attribute;return!1===i?void 0:"string"==typeof i?i:"string"==typeof e?e.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){this._$ES=new Promise(e=>this.enableUpdating=e),this._$AL=new Map,this._$E_(),this.requestUpdate(),this.constructor.l?.forEach(e=>e(this))}addController(e){(this._$EO??=new Set).add(e),void 0!==this.renderRoot&&this.isConnected&&e.hostConnected?.()}removeController(e){this._$EO?.delete(e)}_$E_(){const e=new Map,t=this.constructor.elementProperties;for(const i of t.keys())this.hasOwnProperty(i)&&(e.set(i,this[i]),delete this[i]);e.size>0&&(this._$Ep=e)}createRenderRoot(){const e=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return((e,a)=>{if(i)e.adoptedStyleSheets=a.map(e=>e instanceof CSSStyleSheet?e:e.styleSheet);else for(const i of a){const a=document.createElement("style"),r=t.litNonce;void 0!==r&&a.setAttribute("nonce",r),a.textContent=i.cssText,e.appendChild(a)}})(e,this.constructor.elementStyles),e}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(!0),this._$EO?.forEach(e=>e.hostConnected?.())}enableUpdating(e){}disconnectedCallback(){this._$EO?.forEach(e=>e.hostDisconnected?.())}attributeChangedCallback(e,t,i){this._$AK(e,i)}_$ET(e,t){const i=this.constructor.elementProperties.get(e),a=this.constructor._$Eu(e,i);if(void 0!==a&&!0===i.reflect){const r=(void 0!==i.converter?.toAttribute?i.converter:v).toAttribute(t,i.type);this._$Em=e,null==r?this.removeAttribute(a):this.setAttribute(a,r),this._$Em=null}}_$AK(e,t){const i=this.constructor,a=i._$Eh.get(e);if(void 0!==a&&this._$Em!==a){const e=i.getPropertyOptions(a),r="function"==typeof e.converter?{fromAttribute:e.converter}:void 0!==e.converter?.fromAttribute?e.converter:v;this._$Em=a;const n=r.fromAttribute(t,e.type);this[a]=n??this._$Ej?.get(a)??n,this._$Em=null}}requestUpdate(e,t,i,a=!1,r){if(void 0!==e){const n=this.constructor;if(!1===a&&(r=this[e]),i??=n.getPropertyOptions(e),!((i.hasChanged??x)(r,t)||i.useDefault&&i.reflect&&r===this._$Ej?.get(e)&&!this.hasAttribute(n._$Eu(e,i))))return;this.C(e,t,i)}!1===this.isUpdatePending&&(this._$ES=this._$EP())}C(e,t,{useDefault:i,reflect:a,wrapped:r},n){i&&!(this._$Ej??=new Map).has(e)&&(this._$Ej.set(e,n??t??this[e]),!0!==r||void 0!==n)||(this._$AL.has(e)||(this.hasUpdated||i||(t=void 0),this._$AL.set(e,t)),!0===a&&this._$Em!==e&&(this._$Eq??=new Set).add(e))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(e){Promise.reject(e)}const e=this.scheduleUpdate();return null!=e&&await e,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),this._$Ep){for(const[e,t]of this._$Ep)this[e]=t;this._$Ep=void 0}const e=this.constructor.elementProperties;if(e.size>0)for(const[t,i]of e){const{wrapped:e}=i,a=this[t];!0!==e||this._$AL.has(t)||void 0===a||this.C(t,void 0,i,a)}}let e=!1;const t=this._$AL;try{e=this.shouldUpdate(t),e?(this.willUpdate(t),this._$EO?.forEach(e=>e.hostUpdate?.()),this.update(t)):this._$EM()}catch(t){throw e=!1,this._$EM(),t}e&&this._$AE(t)}willUpdate(e){}_$AE(e){this._$EO?.forEach(e=>e.hostUpdated?.()),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(e)),this.updated(e)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(e){return!0}update(e){this._$Eq&&=this._$Eq.forEach(e=>this._$ET(e,this[e])),this._$EM()}updated(e){}firstUpdated(e){}};y.elementStyles=[],y.shadowRootOptions={mode:"open"},y[b("elementProperties")]=new Map,y[b("finalized")]=new Map,g?.({ReactiveElement:y}),(_.reactiveElementVersions??=[]).push("2.1.2");const $=globalThis,k=e=>e,M=$.trustedTypes,D=M?M.createPolicy("lit-html",{createHTML:e=>e}):void 0,T="$lit$",z=`lit$${Math.random().toFixed(9).slice(2)}$`,A="?"+z,S=`<${A}>`,E=document,C=()=>E.createComment(""),P=e=>null===e||"object"!=typeof e&&"function"!=typeof e,O=Array.isArray,F="[ \t\n\f\r]",N=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,R=/-->/g,I=/>/g,L=RegExp(`>|${F}(?:([^\\s"'>=/]+)(${F}*=${F}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`,"g"),H=/'/g,B=/"/g,U=/^(?:script|style|textarea|title)$/i,j=(e=>(t,...i)=>({_$litType$:e,strings:t,values:i}))(1),W=Symbol.for("lit-noChange"),K=Symbol.for("lit-nothing"),V=new WeakMap,q=E.createTreeWalker(E,129);function G(e,t){if(!O(e)||!e.hasOwnProperty("raw"))throw Error("invalid template strings array");return void 0!==D?D.createHTML(t):t}const J=(e,t)=>{const i=e.length-1,a=[];let r,n=2===t?"<svg>":3===t?"<math>":"",s=N;for(let t=0;t<i;t++){const i=e[t];let o,l,d=-1,c=0;for(;c<i.length&&(s.lastIndex=c,l=s.exec(i),null!==l);)c=s.lastIndex,s===N?"!--"===l[1]?s=R:void 0!==l[1]?s=I:void 0!==l[2]?(U.test(l[2])&&(r=RegExp("</"+l[2],"g")),s=L):void 0!==l[3]&&(s=L):s===L?">"===l[0]?(s=r??N,d=-1):void 0===l[1]?d=-2:(d=s.lastIndex-l[2].length,o=l[1],s=void 0===l[3]?L:'"'===l[3]?B:H):s===B||s===H?s=L:s===R||s===I?s=N:(s=L,r=void 0);const h=s===L&&e[t+1].startsWith("/>")?" ":"";n+=s===N?i+S:d>=0?(a.push(o),i.slice(0,d)+T+i.slice(d)+z+h):i+z+(-2===d?t:h)}return[G(e,n+(e[i]||"<?>")+(2===t?"</svg>":3===t?"</math>":"")),a]};class Y{constructor({strings:e,_$litType$:t},i){let a;this.parts=[];let r=0,n=0;const s=e.length-1,o=this.parts,[l,d]=J(e,t);if(this.el=Y.createElement(l,i),q.currentNode=this.el.content,2===t||3===t){const e=this.el.content.firstChild;e.replaceWith(...e.childNodes)}for(;null!==(a=q.nextNode())&&o.length<s;){if(1===a.nodeType){if(a.hasAttributes())for(const e of a.getAttributeNames())if(e.endsWith(T)){const t=d[n++],i=a.getAttribute(e).split(z),s=/([.?@])?(.*)/.exec(t);o.push({type:1,index:r,name:s[2],strings:i,ctor:"."===s[1]?te:"?"===s[1]?ie:"@"===s[1]?ae:ee}),a.removeAttribute(e)}else e.startsWith(z)&&(o.push({type:6,index:r}),a.removeAttribute(e));if(U.test(a.tagName)){const e=a.textContent.split(z),t=e.length-1;if(t>0){a.textContent=M?M.emptyScript:"";for(let i=0;i<t;i++)a.append(e[i],C()),q.nextNode(),o.push({type:2,index:++r});a.append(e[t],C())}}}else if(8===a.nodeType)if(a.data===A)o.push({type:2,index:r});else{let e=-1;for(;-1!==(e=a.data.indexOf(z,e+1));)o.push({type:7,index:r}),e+=z.length-1}r++}}static createElement(e,t){const i=E.createElement("template");return i.innerHTML=e,i}}function Z(e,t,i=e,a){if(t===W)return t;let r=void 0!==a?i._$Co?.[a]:i._$Cl;const n=P(t)?void 0:t._$litDirective$;return r?.constructor!==n&&(r?._$AO?.(!1),void 0===n?r=void 0:(r=new n(e),r._$AT(e,i,a)),void 0!==a?(i._$Co??=[])[a]=r:i._$Cl=r),void 0!==r&&(t=Z(e,r._$AS(e,t.values),r,a)),t}class X{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){const{el:{content:t},parts:i}=this._$AD,a=(e?.creationScope??E).importNode(t,!0);q.currentNode=a;let r=q.nextNode(),n=0,s=0,o=i[0];for(;void 0!==o;){if(n===o.index){let t;2===o.type?t=new Q(r,r.nextSibling,this,e):1===o.type?t=new o.ctor(r,o.name,o.strings,this,e):6===o.type&&(t=new re(r,this,e)),this._$AV.push(t),o=i[++s]}n!==o?.index&&(r=q.nextNode(),n++)}return q.currentNode=E,a}p(e){let t=0;for(const i of this._$AV)void 0!==i&&(void 0!==i.strings?(i._$AI(e,i,t),t+=i.strings.length-2):i._$AI(e[t])),t++}}class Q{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(e,t,i,a){this.type=2,this._$AH=K,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=i,this.options=a,this._$Cv=a?.isConnected??!0}get parentNode(){let e=this._$AA.parentNode;const t=this._$AM;return void 0!==t&&11===e?.nodeType&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=Z(this,e,t),P(e)?e===K||null==e||""===e?(this._$AH!==K&&this._$AR(),this._$AH=K):e!==this._$AH&&e!==W&&this._(e):void 0!==e._$litType$?this.$(e):void 0!==e.nodeType?this.T(e):(e=>O(e)||"function"==typeof e?.[Symbol.iterator])(e)?this.k(e):this._(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==K&&P(this._$AH)?this._$AA.nextSibling.data=e:this.T(E.createTextNode(e)),this._$AH=e}$(e){const{values:t,_$litType$:i}=e,a="number"==typeof i?this._$AC(e):(void 0===i.el&&(i.el=Y.createElement(G(i.h,i.h[0]),this.options)),i);if(this._$AH?._$AD===a)this._$AH.p(t);else{const e=new X(a,this),i=e.u(this.options);e.p(t),this.T(i),this._$AH=e}}_$AC(e){let t=V.get(e.strings);return void 0===t&&V.set(e.strings,t=new Y(e)),t}k(e){O(this._$AH)||(this._$AH=[],this._$AR());const t=this._$AH;let i,a=0;for(const r of e)a===t.length?t.push(i=new Q(this.O(C()),this.O(C()),this,this.options)):i=t[a],i._$AI(r),a++;a<t.length&&(this._$AR(i&&i._$AB.nextSibling,a),t.length=a)}_$AR(e=this._$AA.nextSibling,t){for(this._$AP?.(!1,!0,t);e!==this._$AB;){const t=k(e).nextSibling;k(e).remove(),e=t}}setConnected(e){void 0===this._$AM&&(this._$Cv=e,this._$AP?.(e))}}class ee{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,t,i,a,r){this.type=1,this._$AH=K,this._$AN=void 0,this.element=e,this.name=t,this._$AM=a,this.options=r,i.length>2||""!==i[0]||""!==i[1]?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=K}_$AI(e,t=this,i,a){const r=this.strings;let n=!1;if(void 0===r)e=Z(this,e,t,0),n=!P(e)||e!==this._$AH&&e!==W,n&&(this._$AH=e);else{const a=e;let s,o;for(e=r[0],s=0;s<r.length-1;s++)o=Z(this,a[i+s],t,s),o===W&&(o=this._$AH[s]),n||=!P(o)||o!==this._$AH[s],o===K?e=K:e!==K&&(e+=(o??"")+r[s+1]),this._$AH[s]=o}n&&!a&&this.j(e)}j(e){e===K?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}}class te extends ee{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===K?void 0:e}}class ie extends ee{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==K)}}class ae extends ee{constructor(e,t,i,a,r){super(e,t,i,a,r),this.type=5}_$AI(e,t=this){if((e=Z(this,e,t,0)??K)===W)return;const i=this._$AH,a=e===K&&i!==K||e.capture!==i.capture||e.once!==i.once||e.passive!==i.passive,r=e!==K&&(i===K||a);a&&this.element.removeEventListener(this.name,this,i),r&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){"function"==typeof this._$AH?this._$AH.call(this.options?.host??this.element,e):this._$AH.handleEvent(e)}}class re{constructor(e,t,i){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(e){Z(this,e)}}const ne=$.litHtmlPolyfillSupport;ne?.(Y,Q),($.litHtmlVersions??=[]).push("3.3.3");const se=globalThis;class oe extends y{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){const e=super.createRenderRoot();return this.renderOptions.renderBefore??=e.firstChild,e}update(e){const t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=((e,t,i)=>{const a=i?.renderBefore??t;let r=a._$litPart$;if(void 0===r){const e=i?.renderBefore??null;a._$litPart$=r=new Q(t.insertBefore(C(),e),e,void 0,i??{})}return r._$AI(e),r})(t,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return W}}oe._$litElement$=!0,oe.finalized=!0,se.litElementHydrateSupport?.({LitElement:oe});const le=se.litElementPolyfillSupport;le?.({LitElement:oe}),(se.litElementVersions??=[]).push("4.2.2");const de={attribute:!0,type:String,converter:v,reflect:!1,hasChanged:x},ce=(e=de,t,i)=>{const{kind:a,metadata:r}=i;let n=globalThis.litPropertyMetadata.get(r);if(void 0===n&&globalThis.litPropertyMetadata.set(r,n=new Map),"setter"===a&&((e=Object.create(e)).wrapped=!0),n.set(i.name,e),"accessor"===a){const{name:a}=i;return{set(i){const r=t.get.call(this);t.set.call(this,i),this.requestUpdate(a,r,e,!0,i)},init(t){return void 0!==t&&this.C(a,void 0,e,t),t}}}if("setter"===a){const{name:a}=i;return function(i){const r=this[a];t.call(this,i),this.requestUpdate(a,r,e,!0,i)}}throw Error("Unsupported decorator location: "+a)};function he(e){return(t,i)=>"object"==typeof i?ce(e,t,i):((e,t,i)=>{const a=t.hasOwnProperty(i);return t.constructor.createProperty(i,e),a?Object.getOwnPropertyDescriptor(t,i):void 0})(e,t,i)}function pe(e){return he({...e,state:!0,attribute:!1})}const ue=864e5,_e=e=>Array.isArray(e)?e.map(e=>String(e).trim()).filter(Boolean):[];function me(e){const t=e.match(/[\p{L}\p{N}]/u);return t?.index??0}function fe(e,t){if(!function(e){return _e(e.match_title_prefixes).length>0||_e(e.match_title_contains).length>0||_e(e.match_title_regex).length>0}(t))return!0;const i=e.toLocaleLowerCase(),a=function(e){return e.slice(me(e))}(e).toLocaleLowerCase();return!!_e(t.match_title_prefixes).some(e=>a.startsWith(e.toLocaleLowerCase()))||(!!_e(t.match_title_contains).some(e=>i.includes(e.toLocaleLowerCase()))||_e(t.match_title_regex).some(t=>{try{return new RegExp(t,"iu").test(e)}catch{return!1}}))}function ge(e,t,i){const a=e=>{return(i=e.calendar,Array.isArray(i)?i.filter(Boolean):i?[i]:[]).includes(t);var i},r=i.flatMap((t,i)=>t.unmatched||!a(t)?[]:fe(e,t)?[i]:[]);return r.length>0?r:i.flatMap((e,t)=>e.unmatched&&a(e)?[t]:[])}function be(e,t){if(!t.strip_title_prefix)return e;const i=me(e),a=e.slice(0,i).trim(),r=e.slice(i),n=r.toLocaleLowerCase(),s=_e(t.match_title_prefixes).find(e=>n.startsWith(e.toLocaleLowerCase()));if(!s)return e;return[a,r.slice(s.length).trimStart()].filter(Boolean).join(" ").trim()||e}function ve(e,t,i,a){const r=!e?.start?.dateTime;let n,s;if(r){if(!e?.start?.date)return null;n=new Date(`${e.start.date}T00:00:00`),s=e.end?.date?new Date(`${e.end.date}T00:00:00`):new Date(n.getTime()+ue)}else n=new Date(e.start.dateTime),s=new Date(e.end?.dateTime??e.start.dateTime);return isNaN(n.getTime())||isNaN(s.getTime())?null:(s.getTime()<=n.getTime()&&(s=new Date(n.getTime()+(r?ue:6e4))),{personIdx:t,calendar:i,uid:e.uid,recurrence_id:e.recurrence_id,rrule:e.rrule,summary:e.summary||"Termin",description:e.description,location:e.location,allDay:r,start:n,end:s,color:a,tentative:!1})}function xe(e,t,i){const a=[],r=new Date(e.start);r.setHours(0,0,0,0);const n=Math.max(1,Math.ceil((e.end.getTime()-r.getTime())/ue));for(let s=0;s<i;s++){const i=new Date(t.getTime()+s*ue),o=new Date(i.getTime()+ue),l=Math.max(e.start.getTime(),i.getTime()),d=Math.min(e.end.getTime(),o.getTime());if(d<=l)continue;const c=e.allDay?0:Math.round((l-i.getTime())/6e4),h=e.allDay?1440:Math.round((d-i.getTime())/6e4),p=n>1?Math.round((i.getTime()-r.getTime())/ue)+1:void 0;a.push({part:p,parts:n>1?n:void 0,ref:e,personIdx:e.personIdx,day:s,startMin:c,endMin:Math.min(h,1440),title:e.summary,location:e.location,allDay:e.allDay,color:e.color,continuesBefore:e.start.getTime()<i.getTime(),continuesAfter:e.end.getTime()>o.getTime()})}return a}function we(e){const t=[...e].sort((e,t)=>e.startMin-t.startMin||e.endMin-t.endMin),i=[];let a=[],r=-1,n=0;const s=[],o=()=>{if(a.length){const e=Math.max(...a.map(e=>e.col))+1;a.forEach(t=>{t.cols=e,t.cluster=n;let i=e;for(const e of a)e!==t&&e.col>t.col&&e.startMin<t.endMin&&e.endMin>t.startMin&&(i=Math.min(i,e.col));t.span=Math.max(1,i-t.col)}),n++}a=[]};for(const e of t){a.length&&e.startMin>=r&&(o(),s.length=0);let t=s.findIndex(t=>t<=e.startMin);-1===t?(t=s.length,s.push(e.endMin)):s[t]=e.endMin;const l={...e,col:t,cols:1,span:1,cluster:n};a.push(l),i.push(l),r=1===a.length?e.endMin:Math.max(r,e.endMin)}return o(),i}const ye=["day","timeline","week","month","agenda"];function $e(e){return"wall"===e?"wall":"default"}const ke=s`
  .moran-wall-shell {
...
`,Me={board_title:"Family board",wall_board_title:"Family Board",wall_calendar_identity:"Calendar",day:"Day",week:"Week",month:"Month",agenda:"Agenda",timeline:"Timeline",all_day:"all-day",this_week:"This week",prev_week:"Previous week",next_week:"Next week",prev_month:"Previous month",next_month:"Next month",today:"Today",tomorrow:"Tomorrow",yesterday:"Yesterday",open_map:"Map",status_home:"home",status_away:"away",add_event:"Add event",new_event:"New event",event:"Event",edit_event:"Edit event",close:"Close",field_title:"Title",field_all_day:"All-day",field_start:"Start",field_end:"End",field_location:"Location",field_note:"Note",field_calendar:"Calendar",recurring:"Recurring event",recur_this:"This event only",recur_future:"This and following",read_only:"This calendar is read-only.",delete:"Delete",cancel:"Cancel",save:"Save",err_invalid:"Please enter valid times.",err_end_before:"End is before start.",err_end_equal:"End must be after start.",save_failed:"Saving failed.",delete_failed:"Deleting failed.",default_title:"Event",load_error:"Calendar could not be loaded.",no_events:"No events.",more_events:"more events",focus_next:"next",focus_free:"free"},De={en:Me,de:{board_title:"Familienplan",wall_board_title:"Familienplan",wall_calendar_identity:"Kalender",day:"Tag",week:"Woche",month:"Monat",agenda:"Agenda",timeline:"Zeitstrahl",all_day:"ganztägig",this_week:"Diese Woche",prev_week:"Vorherige Woche",next_week:"Nächste Woche",prev_month:"Vorheriger Monat",next_month:"Nächster Monat",today:"Heute",tomorrow:"Morgen",yesterday:"Gestern",open_map:"Karte",status_home:"zuhause",status_away:"unterwegs",add_event:"Termin hinzufügen",new_event:"Neuer Termin",event:"Termin",edit_event:"Termin bearbeiten",close:"Schließen",field_title:"Titel",field_all_day:"Ganztägig",field_start:"Start",field_end:"Ende",field_location:"Ort",field_note:"Notiz",field_calendar:"Kalender",recurring:"Wiederkehrender Termin",recur_this:"Nur dieser Termin",recur_future:"Dieser und folgende",read_only:"Dieser Kalender ist schreibgeschützt.",delete:"Löschen",cancel:"Abbrechen",save:"Speichern",err_invalid:"Bitte gültige Zeiten angeben.",err_end_before:"Ende liegt vor dem Start.",err_end_equal:"Ende muss nach dem Start liegen.",save_failed:"Speichern fehlgeschlagen.",delete_failed:"Löschen fehlgeschlagen.",default_title:"Termin",load_error:"Kalender konnte nicht geladen werden.",no_events:"Keine Termine.",more_events:"weitere Termine",focus_next:"als Nächstes",focus_free:"frei"}};function Te(e){return(e?.locale?.language||navigator?.language||"en").toLowerCase().split("-")[0]}function ze(e,t){const i=Te(e);return De[i]?.[t]??Me[t]??t}function Ae(e){return e?.locale?.language||navigator?.language||"en"}function Se(e){const t=e?.locale?.time_format;if("12"===t)return!0;if("24"===t)return!1;const i=new Intl.DateTimeFormat(Ae(e),{hour:"numeric"}).format(new Date(2020,0,1,13));return/\s?[AaPp]\.?[Mm]\.?/.test(i)||/1\s?PM/i.test(i)}function Ee(e,t){return new Intl.DateTimeFormat(Ae(e),{hour:Se(e)?"numeric":"2-digit",minute:"2-digit",hour12:Se(e)}).format(t)}function Ce(e,t){const i=new Date(2020,0,1,0,0,0,0);return i.setMinutes(t),Ee(e,i)}function Pe(e,t,i=1){const a=new Intl.DateTimeFormat(Ae(e),{weekday:t}),r=Array.from({length:7},(e,t)=>{const i=a.format(new Date(2024,0,7+t));return i.charAt(0).toUpperCase()+i.slice(1)});return Array.from({length:7},(e,t)=>r[(i+t)%7])}function Oe(e,t,i=new Date){const a=t.getTime()-i.getTime();if(a<=0)return"";const r=new Intl.RelativeTimeFormat(Ae(e),{numeric:"always",style:"short"}),n=Math.round(a/6e4);if(n<60)return r.format(Math.max(1,n),"minute");const s=Math.round(n/60);return s<24?r.format(s,"hour"):r.format(Math.round(s/24),"day")}const Fe=["#8B7CF6","#34D399","#FBBF24","#FB7185","#22D3EE","#C084FC","#A3E635","#FB923C","#F472B6","#60A5FA"],Ne={"clear-night":"weather-night",cloudy:"weather-cloudy",fog:"weather-fog",hail:"weather-hail",lightning:"weather-lightning","lightning-rainy":"weather-lightning-rainy",partlycloudy:"weather-partly-cloudy",pouring:"weather-pouring",rainy:"weather-rainy",snowy:"weather-snowy","snowy-rainy":"weather-snowy-rainy",sunny:"weather-sunny",windy:"weather-windy","windy-variant":"weather-windy-variant",exceptional:"weather-cloudy-alert"},Re=[[/zahnarzt|dentist|kieferortho/i,"🦷"],[/arzt|doctor|doktor|klinik|hospital|therapie|physio|impf/i,"🩺"],[/geburtstag|geb\.|birthday|jubiläum|jubilaeum|anniversary/i,"🎂"],[/schwimm|swim|hallenbad|baden/i,"🏊"],[/fußball|fussball|soccer|football|training/i,"⚽"],[/sport|gym|fitness|turnen|joggen|laufen|workout/i,"🏃"],[/reit|pferd|pony|horse/i,"🐴"],[/tanz|ballett|dance/i,"🩰"],[/klavier|gitarre|musik|music|chor|singen|band|orchester|instrument/i,"🎵"],[/schule|unterricht|klasse|klassenverbund|school|nachhilfe|lernen|prüfung|pruefung|klausur/i,"🎒"],[/kita|kindergarten|krippe|hort/i,"🧸"],[/frühstück|fruehstueck|breakfast/i,"🥐"],[/mittag|lunch|abendessen|dinner|essen|kochen|restaurant|brunch/i,"🍽️"],[/kaffee|coffee|café|cafe/i,"☕"],[/urlaub|ferien|vacation|holiday|reise|trip|strand|beach/i,"🏖️"],[/flug|flight|airport|flughafen/i,"✈️"],[/zug|bahn|train|abfahrt|ankunft/i,"🚆"],[/kino|film|movie|cinema/i,"🎬"],[/party|feier|fest|celebration/i,"🎉"],[/einkauf|shopping|supermarkt|einkaufen|besorgung/i,"🛒"],[/putz|reinig|cleaning|wäsche|waesche|müll|muell|garbage|trash/i,"🧹"],[/schlaf|nap|ruhezeit|mittagsschlaf/i,"😴"],[/spiel|freispiel|play|angebotszeit/i,"🧸"],[/meeting|besprechung|termin|call|konferenz|conference|office|büro|buero|arbeit|work/i,"💼"],[/friseur|haircut|hairdresser|frisör|frisoer/i,"💇"],[/kirche|church|gottesdienst|messe|religion/i,"⛪"],[/pause|hofpause|break/i,"⏸️"]],Ie=/\p{Extended_Pictographic}/u,Le=e=>String(e).padStart(2,"0"),He=e=>new Date(e.getTime()-6e4*e.getTimezoneOffset()).toISOString().slice(0,16),Be=e=>new Date(e.getTime()-6e4*e.getTimezoneOffset()).toISOString().slice(0,10),Ue=e=>{const t=new Date(e);return t.setHours(0,0,0,0),t},je=(e,t)=>e.color||Fe[t%Fe.length],We=e=>{let t=0;for(let i=0;i<e.length;i++)t=31*t+e.charCodeAt(i)>>>0;return Fe[t%Fe.length]};function Ke(e){const t=e?.states??{},i=Object.keys(t).filter(e=>e.startsWith("calendar.")),a=e=>e.toLowerCase().normalize("NFD").replace(/[\u0300-\u036f]/g,"").replace(/[^a-z0-9]/g,""),r=[];for(const e of Object.keys(t)){if(!e.startsWith("person."))continue;const n=e.slice(7),s=t[e].attributes?.friendly_name??n,o=a(n),l=a(s),d=i.filter(e=>{const i=a(e.slice(9)),r=a(t[e].attributes?.friendly_name??"");return i===o||i.includes(o)||l.length>2&&(i.includes(l)||r.includes(l))});if(r.push({name:s,person:e,calendar:1===d.length?d[0]:d.length?d:""}),r.length>=10)break}return r}class Ve extends oe{constructor(){super(...arguments),this.nowProvider=()=>new Date,this._layout="default",this._events=[],this._view="day",this._day=((new Date).getDay()+6)%7,this._weekOffset=0,this._monthOffset=0,this._loadError=!1,this._loading=!1,this._fitPx=0,this._hiddenP=[],this._dragStartY=0,this._dragPx=1,this._dragGrid=30,this._suppressClick=!1,this._raw=[],this._fetchedKey="",this._forecast={},this._weatherKey="",this._scrolledKey="",this._lastInteract=Date.now(),this._onInteract=()=>{this._lastInteract=Date.now()},this._onVisible=()=>{"hidden"!==document.visibilityState&&this.hass&&this._config&&this._refetch()},this._onKeyDown=e=>{"Escape"===e.key&&this._dialog&&(e.stopPropagation(),this._closeDialog())},this._prevWeek=()=>{this._weekOffset-=1},this._nextWeek=()=>{this._weekOffset+=1},this._thisWeek=()=>{this._weekOffset=0,this._day=this._todayIndex()},this._prevMonth=()=>{this._monthOffset-=1},this._nextMonth=()=>{this._monthOffset+=1},this._thisMonth=()=>{this._monthOffset=0},this._onDragMove=e=>{if(!this._drag)return;e.preventDefault();const t=e.clientY-this._dragStartY,i=this._drag.moved||Math.abs(t)>4;this._drag={...this._drag,deltaMin:t/this._dragPx,moved:i}},this._onDragUp=()=>{window.removeEventListener("pointermove",this._onDragMove),window.removeEventListener("pointerup",this._onDragUp);const e=this._drag;e&&(e.moved?(this._suppressClick=!0,this._commitDrag(e)):this._drag=void 0)}}_now(){return new Date(this.nowProvider().getTime())}static async getConfigElement(){return await Promise.resolve().then(function(){return et}),document.createElement("moran-family-board-card-editor")}static getStubConfig(e){const t=e?Ke(e):[];return{type:"custom:moran-family-board-card",view:"day",time_grid:30,start_hour:6,end_hour:22,show_weekends:!0,show_now_line:!0,color_by:"person",persons:t.length?t:[{name:"Person 1",person:"",calendar:""},{name:"Person 2",person:"",calendar:""}]}}setConfig(e){if(!e.persons||!Array.isArray(e.persons))throw new Error("Bitte mindestens eine Person unter 'persons' konfigurieren.");this._config=e,this._layout=$e(e.layout);const t=this._enabledViews,i=e.view??"day";this._view=t.includes(i)?i:t[0],this._day=this._todayIndex(),this._hiddenP=e.persons.map((e,t)=>e.hidden?t:-1).filter(e=>e>=0);const a=Number(e.col_min_width);Number.isFinite(a)&&a>=60?this.style.setProperty("--fb-col-min",`${Math.min(a,400)}px`):this.style.removeProperty("--fb-col-min"),this.toggleAttribute("compact",!0===e.compact);const r=Number(e.event_size);Number.isFinite(r)&&r>=8&&r<=20?(this.style.setProperty("--fb-event-size",`${r}px`),this.style.setProperty("--fb-chip-size",`${Math.max(r-1,8)}px`)):(this.style.removeProperty("--fb-event-size"),this.style.removeProperty("--fb-chip-size"));const n=Number(e.radius);Number.isFinite(n)&&n>=0&&n<=20?(this.style.setProperty("--fb-radius",`${n}px`),this.style.setProperty("--fb-radius-sm",`${Math.max(n-2,2)}px`)):(this.style.removeProperty("--fb-radius"),this.style.removeProperty("--fb-radius-sm"));const s=Number(e.past_opacity);Number.isFinite(s)&&s>=10&&s<=100?this.style.setProperty("--fb-past-opacity",""+s/100):this.style.removeProperty("--fb-past-opacity"),this.isConnected&&this._startTimer()}get _enabledViews(){const e=this._config?.views,t=Array.isArray(e)?ye.filter(t=>e.includes(t)):[];return t.length?t:[...ye]}get _firstDayJs(){return"sunday"===this._config?.first_day?0:1}_todayIndex(){return(this._now().getDay()-this._firstDayJs+7)%7}getCardSize(){return 12}connectedCallback(){super.connectedCallback(),document.addEventListener("keydown",this._onKeyDown),document.addEventListener("visibilitychange",this._onVisible),window.addEventListener("focus",this._onVisible),this._startTimer(),this.addEventListener("pointerdown",this._onInteract),this._tick=window.setInterval(()=>{this._kioskReturn(),this.requestUpdate()},6e4),"undefined"!=typeof ResizeObserver&&(this._ro=new ResizeObserver(()=>requestAnimationFrame(()=>this._measureFit())),this._ro.observe(this))}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("keydown",this._onKeyDown),document.removeEventListener("visibilitychange",this._onVisible),window.removeEventListener("focus",this._onVisible),this.removeEventListener("pointerdown",this._onInteract),this._stopTimer(),this._tick&&(clearInterval(this._tick),this._tick=void 0),this._ro?.disconnect(),this._ro=void 0,window.removeEventListener("pointermove",this._onDragMove),window.removeEventListener("pointerup",this._onDragUp)}get _progressOn(){return!1!==this._config?.show_progress}_isCurrent(e){const t=this._now().getTime();return e.ref.start.getTime()<=t&&t<e.ref.end.getTime()}_progressPct(e){const t=e.ref.start.getTime(),i=e.ref.end.getTime();return i<=t?0:Math.min(100,Math.max(0,(this._now().getTime()-t)/(i-t)*100))}_kioskReturn(){const e=Number(this._config?.auto_return??0);if(!Number.isFinite(e)||e<=0)return;if(Date.now()-this._lastInteract<6e4*e)return;if(this._dialog)return;const t=this._config.view??"day",i=this._enabledViews.includes(t)?t:this._enabledViews[0];this._view!==i&&(this._view=i),0!==this._weekOffset&&(this._weekOffset=0),0!==this._monthOffset&&(this._monthOffset=0),this._hiddenP.length&&(this._hiddenP=[]),this._day=this._todayIndex()}_startTimer(){this._stopTimer();const e=this._config?.refresh_interval??300;e>0&&(this._timer=window.setInterval(()=>this._refetch(),1e3*e))}_stopTimer(){this._timer&&(clearInterval(this._timer),this._timer=void 0)}updated(e){(e.has("hass")||e.has("_config"))&&this.hass&&this._config&&(this._maybeFetch(),this._maybeFetchWeather()),e.has("_dialog")&&this._manageDialogFocus(e.get("_dialog")),this._measureFit(),this._maybeScrollToNow()}_measureFit(){if(this._applyFullHeight(),!this._config?.fit_height||"day"!==this._view)return void(0!==this._fitPx&&(this._fitPx=0));const e=this.renderRoot?.querySelector(".board");if(!e)return;const t=e.querySelector(".header-row"),i=e.querySelector(".allday-row"),a=this._visibleDays.includes(this._day)?this._day:this._visibleDays[0],r=this._dayWindow(a),n=r.endMin-r.startMin;if(n<=0)return;const s=(t?.offsetHeight??0)+(i?.offsetHeight??0),o=e.clientHeight-s-2;if(o<=0)return;const l=Math.min(96,Math.max(40,this._config.hour_height??64))/60,d=Math.max(40/60,Math.min(l,o/n));Math.abs(d-this._fitPx)>.02&&(this._fitPx=d)}_applyFullHeight(){const e=this.renderRoot?.querySelector(".board");if(!e)return;if(!this._config?.full_height)return void(e.style.height&&(e.style.height="",e.style.maxHeight=""));const t=e.getBoundingClientRect().top+window.scrollY,i=`${Math.max(200,Math.round(window.innerHeight-t-16))}px`;e.style.height!==i&&(e.style.height=i,e.style.maxHeight=i)}_maybeScrollToNow(){if("day"!==this._view||!1===this._config?.scroll_to_now)return;const e=this._visibleDays.includes(this._day)?this._day:this._visibleDays[0];if(!this._isRealToday(e))return;const t=`${this._weekOffset}|${this._day}|${this._config?.hour_height}`;if(t===this._scrolledKey)return;const i=this.renderRoot?.querySelector(".board"),a=this.renderRoot?.querySelector(".nowline");i&&a&&(this._scrolledKey=t,requestAnimationFrame(()=>{const e=a.offsetTop-i.clientHeight/3;i.scrollTo({top:Math.max(0,e),behavior:"smooth"})}))}_manageDialogFocus(e){this._dialog&&!e?(this._restoreFocus=this.renderRoot?.activeElement,requestAnimationFrame(()=>{const e=this.renderRoot?.querySelector(".dialog input");e?.focus()})):!this._dialog&&e&&(this._restoreFocus?.focus?.(),this._restoreFocus=void 0)}_weekBounds(){const e=this._now(),t=new Date(e);t.setHours(0,0,0,0),t.setDate(e.getDate()-(e.getDay()-this._firstDayJs+7)%7+7*this._weekOffset);const i=new Date(t);return i.setDate(t.getDate()+7),{monday:t,nextMonday:i}}_monthGrid(){const e=this._now(),t=new Date(e.getFullYear(),e.getMonth()+this._monthOffset,1),i=(t.getDay()-this._firstDayJs+7)%7,a=Ue(new Date(t.getFullYear(),t.getMonth(),1-i)),r=new Date(t.getFullYear(),t.getMonth()+1,0).getDate();return{gridStart:a,weeks:Math.ceil((i+r)/7),month:t.getMonth(),year:t.getFullYear()}}_fetchRange(){if("month"===this._view){const{gridStart:e,weeks:t}=this._monthGrid();return{start:e,end:new Date(e.getTime()+7*t*ue)}}const{monday:e,nextMonday:t}=this._weekBounds();return{start:e,end:t}}async _maybeFetch(){const e=[...new Set(this._config.persons.flatMap(e=>this._calsOf(e)))].sort().join(","),t=this._config.persons.map(e=>[this._calsOf(e).sort().join("~"),e.color??"",e.match_title_prefixes?.join("~")??"",e.match_title_contains?.join("~")??"",e.match_title_regex?.join("~")??"",e.unmatched?"u":"",e.strip_title_prefix?"s":""].join(":")).join(","),i=`${"month"===this._view?`m${this._monthOffset}`:`w${this._weekOffset}`}|${e}|${t}`;i!==this._fetchedKey&&(this._fetchedKey=i,await this._fetchEvents())}async _refetch(){this._fetchedKey="",await this._maybeFetch()}async _maybeFetchWeather(){const e=this._config.weather_entity;if(!e||!1===this._config.show_weather||!this.hass.states[e])return Object.keys(this._forecast).length&&(this._forecast={}),void(this._weatherKey="");const t=`${e}|${(new Date).toISOString().slice(0,10)}`;if(t!==this._weatherKey){this._weatherKey=t;try{const t=await this.hass.callWS({type:"call_service",domain:"weather",service:"get_forecasts",service_data:{type:"daily"},target:{entity_id:e},return_response:!0}),i=t?.response?.[e]?.forecast??[],a={};for(const e of i)e?.datetime&&(a[Be(new Date(e.datetime))]={temp:Math.round(e.temperature),condition:e.condition});this._forecast=a}catch(e){this._forecast={}}}}_weatherChip(e){const t=this._forecast[Be(e)];if(!t)return K;const i=Ne[t.condition]||"weather-cloudy",a=this.hass.config?.unit_system?.temperature??"°";return j`<span class="wx" title=${t.condition}>
    ...
    </div>`}_moreInfo(e){this.dispatchEvent(new CustomEvent("hass-more-info",{detail:{entityId:e},bubbles:!0,composed:!0}))}_goToDate(e){const t=Ue(this._now()),i=e=>{const t=Ue(e);return t.setDate(t.getDate()-(t.getDay()-this._firstDayJs+7)%7),t},a=Math.round((i(e).getTime()-i(t).getTime())/(7*ue));this._weekOffset=a,this._day=(e.getDay()-this._firstDayJs+7)%7,this._view=this._enabledViews.includes("day")?"day":this._view}render(){if(!this._config||!this.hass)return K;const e=this._renderViewSwitcher(),t=this._config.show_focus?this._renderFocus():K,i=this._renderActiveView(),a="wall"===this._layout?function({title:e,calendarIdentity:t,viewNavigation:i,focus:a,content:r}){return j`
  ...
  `}({title:this._config.title??this._t("wall_board_title"),calendarIdentity:this._t("wall_calendar_identity"),viewNavigation:e,focus:t,content:i}):j`
            <ha-card>
              <div class="top">
          ...
          `;return j`${a} ${this._dialog?this._renderDialog():K}`}_renderViewSwitcher(){return this._enabledViews.length>1?j`<div class="switch" role="tablist">
        ...
        </div>`:K}_renderActiveView(){return"day"===this._view?this._renderDay():"timeline"===this._view?this._renderTimeline():"week"===this._view?this._renderWeek():"month"===this._view?this._renderMonth():this._renderAgenda()}_focusFor(e){const t=this._now().getTime(),i=this._raw.filter(t=>t.personIdx===e&&!t.allDay).sort((e,t)=>e.start.getTime()-t.start.getTime()),a=i.find(e=>e.start.getTime()<=t&&t<e.end.getTime()),r=i.find(e=>e.start.getTime()>t);return{current:a,next:r}}_renderFocus(){return j`
      <div class="focus">
        ${this._persons.map((e,t)=>{if(this._isOff(t))return K;const{current:i,next:a}=this._focusFor(t),r=je(e,t),n=e=>this._config.auto_icons?this._autoIcon(e.summary):"";return j`
            <div class="fchip" title=${this._personName(e,t)}>
              ${this._avatar(e,t)}
              <div class="fbody">
                <span class="fname">${this._personName(e,t)}</span>
                ${i?j`<span class="fnow">
                      <span class="fdot" style="background:${r}"></span>${n(i)}
                      ${i.summary}
                      <small>bis ${Ee(this.hass,i.end)}</small>
                    </span>`:a?j`<span class="fnext">
                        ${this._t("focus_next")}: ${n(a)} ${a.summary}
                        <small>${Oe(this.hass,a.start,this._now())}</small>
    ...
    `}_weekNav(){const{monday:e}=this._weekBounds();return j`
      <div class="weeknav">
        ...
        <button class="nav-now" @click=${this._thisWeek}>
          ${function(e,t){const i=new Date(t.getTime()+5184e5),a=new Intl.DateTimeFormat(Ae(e),{day:"numeric",month:"short"});return`${a.format(t)} – ${a.format(i)}`}(this.hass,e)}
        </button>
        <button class="nav" aria-label=${this._t("next_week")} @click=${this._nextWeek}>›</button>
      </div>
    `}_renderDayTabs(){const e=Pe(this.hass,"short",this._firstDayJs);return j`
    ...
    `}_renderDay(){const e=this._visibleDays.includes(this._day)?this._day:this._visibleDays[0],t=this._pxPerMin,i=60*t,{startMin:a,endMin:r}=this._dayWindow(e),n=(r-a)*t,s=Pe(this.hass,"long",this._firstDayJs),o=[];for(let e=a/60;e<=r/60;e++)o.push(e);const l=this._now(),d=Math.max(a,Math.min(r,60*l.getHours()+l.getMinutes())),c=!1!==this._config.show_now_line&&this._isRealToday(e),h=this._persons.some((t,i)=>this._allDayFor(e,i).length>0);return j`
      <div class="dayhead">
        <span class="dayname">
      ...
      <div class="board">
        <div class="header-row">
          ...
          ${this._persons.map((e,t)=>{const i=e.person?this.hass.states[e.person]:void 0,a=this._isOff(t);return j`
              ...
              >
                ${this._avatar(e,t)}
                ${a?K:j`<div class="pname">${this._personName(e,t)}</div>
                      <div class="pstatus">
        ...
        <div class="body" style="height:${n}px">
          <div class="axis">
            ${o.map(e=>j`<div class="hour" style="top:${(60*e-a)*t}px">
                  ${Le(e)}:00
                </div>`)}
          </div>
          ${this._persons.map((n,s)=>{const o=this._personCanCreate(n),l=this._dayLayout(e,s);return j`
              <div
              ...
              >
                ${this._bgFor(e,s).filter(e=>e.endMin>a&&e.startMin<r).map((e,i)=>{const r=(e.startMin-a)*t,n=Math.max((e.endMin-e.startMin)*t-3,16),s=this._eventColor(e),o=this._isTentative(e);return j`
                      <div
                        ...
                        title="${this._evTitle(e)} · ${Ce(this.hass,e.startMin)}–${Ce(this.hass,e.endMin)}"
                      >
                        <span
                          class="etitle"
                ...
                ${(()=>{let e=-1/0;return l.events.filter(e=>e.endMin>a&&e.startMin<r).map(i=>{const r=this._drag?.raw===i.ref;let n=i.startMin,s=i.endMin;if(r&&this._drag){const e=this._dragGrid;if("move"===this._drag.mode){const t=Math.round((i.startMin+this._drag.deltaMin)/e)*e;s=i.endMin+(t-i.startMin),n=t}else{let t=Math.round((i.endMin-i.startMin+this._drag.deltaMin)/e)*e;t<e&&(t=e),s=i.startMin+t}}let o=(n-a)*t;const l=Math.max((s-n)*t-3,16),d=this._eventColor(i),c=i.col/i.cols*100,h=(i.span??1)/i.cols*100,p=this._isTentative(i),u=l<24,_=this._draggable(i);return u&&1===i.cols&&!r&&(o=Math.max(o,e+1),e=o+l),j`
                        <div
                          ...
                          title="${this._evTitle(i)} · ${Ce(this.hass,i.startMin)}–${Ce(this.hass,i.endMin)}"
                        >
                          <span class="etitle"
                            >${this._calIconEl(i)}${i.continuesBefore?"« ":""}${this._evTitle(i)}</span
                          >
                          ${l>32||r?j`<span class="etime"
                                >${Ce(this.hass,n)}–${Ce(this.hass,s)}</span
                              >`:K}
                          ${this._progressOn&&this._isCurrent(i)&&!r?j`<div class="eprog">
                      ...
                      `})})()}
                ${l.overflows.filter(e=>e.endMin>a&&e.startMin<r).map(i=>{const r=(i.startMin-a)*t,n=Math.max((i.endMin-i.startMin)*t-3,16),s=i.col/i.cols*100,o=100/i.cols;return j`
                      <div
            ...
            `})}
          ${c?j`<div class="nowline" style="top:${(d-a)*t}px">
                <span>${Ce(this.hass,d)}</span>
              </div>`:K}
          ${this._loading||this._loadError||this._dayHasEvents(e)?K:j`<div class="empty">${this._t("no_events")}</div>`}
        </div>
      </div>
    `}_renderTimeline(){const e=this._visibleDays.includes(this._day)?this._day:this._visibleDays[0],{startMin:t,endMin:i}=this._dayWindow(e),a=Math.min(240,Math.max(48,Number(this._config.hour_width)||96)),r=a/60,n=(i-t)*r,s=Pe(this.hass,"long",this._firstDayJs),o=[];for(let e=t/60;e<=i/60;e++)o.push(e);const l=this._now(),d=60*l.getHours()+l.getMinutes(),c=!1!==this._config.show_now_line&&this._isRealToday(e)&&d>=t&&d<=i;return j`
      <div class="dayhead">
        <span class="dayname">
          ${this._relativeDay(this._dateForDay(e))??s[e]}
          ${this._weatherChip(this._dateForDay(e))}${this._loading&&0===this._raw.length?j`<span class="spinner"></span>`:K}
        ...
        <div class="tlgrid" style="min-width:calc(var(--fb-tl-label, 150px) + ${n}px)">
          <div class="tlhead">
            ...
            <div class="tlhours" style="width:${n}px">
              ${o.map(e=>j`<span class="tlhour" style="left:${(60*e-t)*r}px"
                    >${Le(e)}:00</span
                  >`)}
            </div>
          </div>
          ${this._persons.map((s,o)=>{const l=this._isOff(o),d=l?[]:this._events.filter(t=>t.day===e&&t.personIdx===o),c=we(d),h=c.length?Math.max(...c.map(e=>e.cols)):1,p=this._personCanCreate(s),u=s.person?this.hass.states[s.person]:void 0;return j`
              <div class="tlrow ${l?"off":""}">
                ...
                <div
                  ...
                  style="width:${n}px;height:${30*h+8}px;
                ...
                >
                  ${c.filter(e=>e.endMin>t&&e.startMin<i).map(e=>{const a=Math.max(e.startMin,t),n=Math.min(e.endMin,i),s=Math.max((n-a)*r-3,20),o=this._eventColor(e),l=this._isTentative(e),d=e.continuesBefore||e.startMin<t,c=e.continuesAfter||e.endMin>i;return j`
                        <div
                          ...
                          title="${this._evTitle(e)}${e.allDay?` · ${this._t("all_day")}`:` · ${Ce(this.hass,e.startMin)}–${Ce(this.hass,e.endMin)}`}"
                        >
                          <span class="etitle"
                            >${d?"« ":""}${this._evTitle(e)}${c?" »":""}</span
                          >
                          ${!e.allDay&&s>120?j`<span class="etime"
                                >${Ce(this.hass,e.startMin)}–${Ce(this.hass,e.endMin)}</span
                              >`:K}
                        </div>
                      `})}
                </div>
                  ...
                  >
                    ${this._eventsFor(t,i).map(e=>{const t=this._eventColor(e),i=this._isTentative(e);return j`
                        ...
                        >
                          ...
                          >
                          ${e.allDay?K:j`<small>${Ce(this.hass,e.startMin)}</small>`}
                        </div>
                      `})}
                  </div>
                `})}
    ...
    `}_agendaRow(e){const t=this._eventColor(e),i=this._personName(this._persons[e.personIdx],e.personIdx),a=e.allDay?this._t("all_day"):`${Ce(this.hass,e.startMin)}–${Ce(this.hass,e.endMin)}`,r=this._isCurrent(e),n=this._isTentative(e),s=e.allDay||r||e.continuesBefore?"":Oe(this.hass,e.ref.start,this._now());return j`
      <div
      ...
      >
        ...
        <span class="agenda-main">
          ...
          ${r&&this._progressOn?j`<span class="agenda-prog"
                ><span style="width:${this._progressPct(e)}%;background:${t}"></span
              ></span>`:K}
        </span>
        ${s?j`<span class="agenda-cd">${s}</span>`:K}
      </div>
    `}_renderMonth(){const{gridStart:e,weeks:t,month:i,year:a}=this._monthGrid(),r=7*t,n=Pe(this.hass,"short",this._firstDayJs),s=this.hass.locale?.language||"en",o=new Intl.DateTimeFormat(s,{month:"long",year:"numeric"}).format(new Date(a,i,1)),l=new Map;for(const t of this._raw)if(!this._isOff(t.personIdx))for(const i of xe(t,e,r)){const e=l.get(i.day);e?e.push(i):l.set(i.day,[i])}const d=Ue(this._now()).getTime();return j`
      <div class="weekhead">
        <div class="weeknav">
      ...
      ${this._loadError?j`<div class="banner">${this._t("load_error")}</div>`:K}
      <div class="monthwrap">
        <div class="monthhead">${n.map(e=>j`<div class="mhcell">${e}</div>`)}</div>
        <div class="monthgrid">
          ${Array.from({length:r},(t,a)=>{const r=new Date(e.getTime()+a*ue),n=r.getMonth()===i,s=r.getTime()===d,o=(l.get(a)||[]).sort((e,t)=>Number(t.allDay)-Number(e.allDay)||e.startMin-t.startMin);return j`
              <div
        ...
        ${e.map((t,i)=>j`
            <div class="person">
              <div class="person-head">
                <span
                  class="pdot"
                  style="background:${t.color||Ye[i%Ye.length]}"
                ></span>
  ...
  `,e([he({attribute:!1})],Qe.prototype,"hass",void 0),e([pe()],Qe.prototype,"_config",void 0),customElements.define("moran-family-board-card-editor",Qe);var et=Object.freeze({__proto__:null,FamilyBoardCardEditor:Qe});export{Ve as FamilyBoardCard,Ke as autoDetectPersons};
