        ...
        <div class="tlgrid" style="min-width:calc(var(--fb-tl-label, 150px) + ${r}px)">
          <div class="tlhead">
            ...
            <div class="tlhours" style="width:${r}px">
              ${l.map((e,i)=>K`<span
                    class=${i===l.length-1?"tlhour tlhour-end":"tlhour"}
                    style="left:${(60*e-t)*n}px"
                    >${"wall"===this._layout?lt(this.hass,e):`${gt(e)}:00`}</span
                  >`)}
              ${o&&c?K`<span
                    class="tlnow-label"
                    style="left:${u+1}px;
                      transform:translateX(clamp(-${u+1}px, -50%,
                        calc(${r-u-1}px - 100%)))"
                    >${st(this.hass,h)}</span
                  >`:U}
            </div>
          ...
          ${c?K`<div
                class="tlnow"
                style="left:calc(var(--fb-tl-label, 150px) + ${u}px)"
              >
                ${o?U:K`<span>${st(this.hass,h)}</span>`}
              </div>`:U}
        </div>
        ${this._loading||this._loadError||this._partialLoad||this._dayHasEvents(e)?U:K`<div class="empty">${this._t("no_events")}</div>`}
      </div>
