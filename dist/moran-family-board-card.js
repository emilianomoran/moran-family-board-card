    ...
    `}_weekNav(){const{monday:e}=this._weekBounds();return j`
      <div class="weeknav">
        ...
        <button class="nav-now" @click=${this._thisWeek}>
          ${function(e,t){const i=new Date(t.getTime()+5184e5),a=new Intl.DateTimeFormat(ze(e),{day:"numeric",month:"short"});return`${a.format(t)} – ${a.format(i)}`}(this.hass,e)}
        </button>
