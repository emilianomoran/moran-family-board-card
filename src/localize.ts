...
const EN: Dict = {
  ...
  show_all_events: "Show all appointments",
  show_fewer_events: "Show fewer appointments",
  show_less: "Show less",
  events: "events",
...
const DE: Dict = {
  ...
  calendar_views: "Kalenderansichten",
  calendar_dates: "Kalenderdaten",
  day: "Tag",
  week: "Woche",
  month: "Monat",
  agenda: "Agenda",
  ...
  show_all_events: "Alle Termine anzeigen",
  show_fewer_events: "Weniger Termine anzeigen",
