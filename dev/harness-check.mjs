...
import { runNativeWeekContextChecks } from "./calendar-week-context-check.mjs";
import { runNativeMonthTodayChecks } from "./calendar-month-today-check.mjs";
...
const scenarios = [
  ...
  {name: "wall", checks: "timeline-labels", chromeHeight: 64, width: 1920, panelWidth: 400,
    expectedGeometryMarker: "timeline labels:"},
  {name: "wall", checks: "timeline-labels", chromeHeight: 64, width: 390, height: 844,
    reducedMotion: true, expectedGeometryMarker: "timeline labels:"},
  ...[[1920,1080], [390,844], [320,568], [844,390]].map(([width,height]) => ({
  ...
  {name: "wall", checks: "month-today", chromeHeight: 64, width: 1920, panelWidth: 400,
    expectedGeometryMarker: "month today:"},
  {name: "wall", checks: "month-today", chromeHeight: 64, width: 390, height: 844,
    reducedMotion: true, expectedGeometryMarker: "month today:"},
  ...[[1920,1080], [390,844], [320,568], [844,390]].map(([width,height]) => ({
    name: "wall", checks: "week-context", chromeHeight: 64, width, height,
    expectedGeometryMarker: "week date context:",
  })),
  {name: "wall", checks: "week-context", chromeHeight: 64, width: 1920, panelWidth: 400,
    expectedGeometryMarker: "week date context:"},
  {name: "wall", checks: "week-context", chromeHeight: 64, width: 390, height: 844,
    reducedMotion: true, expectedGeometryMarker: "week date context:"},
  ...[[1920,1080], [390,844], [320,568], [844,390]].map(([width,height]) => ({
  ...
  {name: "wall", checks: "day-overflow", chromeHeight: 64, width: 1920, panelWidth: 400,
    expectedGeometryMarker: "day overflow:"},
  {name: "wall", checks: "day-overflow", chromeHeight: 64, width: 390, height: 844,
    reducedMotion: true, expectedGeometryMarker: "day overflow:"},
  ...
  {name: "wall", checks: "month-overflow", chromeHeight: 64, width: 1920, panelWidth: 400,
    expectedGeometryMarker: "month overflow:"},
  {name: "wall", checks: "month-overflow", chromeHeight: 64, width: 390, height: 844,
    reducedMotion: true, expectedGeometryMarker: "month overflow:"},
  ...[[1920,1080],[812,844],[390,844],[320,568],[844,390]].map(([width,height])=>({
...
try {
  for (const {
    ...
    if (checks === "week-context") await runNativeWeekContextChecks(cdp, delay);
    if (checks === "month-today") await runNativeMonthTodayChecks(cdp, delay);
