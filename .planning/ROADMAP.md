...
**Wave 4** *(UAT gap closure; blocked on Wave 3 completion)*

- [x] 01-04: Preserve circular wall Day avatars and enforce wall/legacy geometry in the compiled browser harness.
